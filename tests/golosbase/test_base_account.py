...
from golosbase.account import Address, BrainKey, PasswordKey, PrivateKey, PublicKey
...
class Testcases(unittest.TestCase):
    def test_B85hexgetb58_btc(self):
        self.assertEqual(
            ...
            [
                format(Base58("02b52e04a0acfe611a4b6963462aca94b6ae02b24e321eda8650766" "1901adb49"), "WIF"),
                format(Base58("5b921f7051be5e13e177a0253229903c40493df410ae04f4a450c85" "568f19131"), "WIF"),
                format(Base58("0e1bfc9024d1f55a7855dc690e45b2e089d2d825a4671a3c3c7e4ea" "4e74ec00e"), "WIF"),
                format(Base58("6e5cc4653d46e690c709ed9e0570a2c75a286ad7c1bc69a648aae68" "55d919d3e"), "WIF"),
                format(Base58("b84abd64d66ee1dd614230ebbe9d9c6d66d78d93927c39519666676" "2e9ad69d8"), "WIF"),
    ...
    def test_B85hexgetb58(self):
        self.assertEqual(
            ...
            [
                format(Base58("02b52e04a0acfe611a4b6963462aca94b6ae02b24e321eda865" "07661901adb49"), "BTS"),
                format(Base58("5b921f7051be5e13e177a0253229903c40493df410ae04f4a45" "0c85568f19131"), "BTS"),
                format(Base58("0e1bfc9024d1f55a7855dc690e45b2e089d2d825a4671a3c3c7" "e4ea4e74ec00e"), "BTS"),
                format(Base58("6e5cc4653d46e690c709ed9e0570a2c75a286ad7c1bc69a648a" "ae6855d919d3e"), "BTS"),
                format(Base58("b84abd64d66ee1dd614230ebbe9d9c6d66d78d93927c3951966" "66762e9ad69d8"), "BTS"),
            ],
        )
    ...
    def test_BrainKey(self):
        self.assertEqual(
            [
                ...
                str(
                    BrainKey(
                        "CORKITE CORDAGE FONDISH UNDER FORGET BEFLEA OUTBUD "
