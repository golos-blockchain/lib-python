...
class Testcases(unittest.TestCase):
    def test_base58decode(self):
        self.assertEqual(
            ...
            [
                "800c28fca386c7a227600b2fe50b7cae11ec86d3bf1fbe471be89827e" "19d72aa1d507a5b8d",
                "80e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991" "b7852b8555c5bbb26",
                "80f3a375e00cc5147f30bee97bb5d54b31a12eee148a1ac31ac9edc4e" "cd13bc1f80cc8148e",
            ],
        )
    ...
    def test_base58encode(self):
        self.assertEqual(
            ...
            [
                base58encode("800c28fca386c7a227600b2fe50b7cae11ec86d3bf1fbe47" "1be89827e19d72aa1d507a5b8d"),
                base58encode("80e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b93" "4ca495991b7852b8555c5bbb26"),
                base58encode("80f3a375e00cc5147f30bee97bb5d54b31a12eee148a1ac3" "1ac9edc4ecd13bc1f80cc8148e"),
            ],
        )
    ...
    def test_gphBase58CheckEncode(self):
        self.assertEqual(
            [
                gphBase58CheckEncode("02e649f63f8e8121345fd7f47d0d185a3ccaa843115cd2e9" "392dcd9b82263bc680"),
                gphBase58CheckEncode("021c7359cd885c0e319924d97e3980206ad64387aff54908" "241125b3a88b55ca16"),
                gphBase58CheckEncode("02f561e0b57a552df3fa1df2d87a906b7a9fc33a83d5d15f" "a68a644ecb0806b49a"),
    ...
    def test_gphBase58CheckDecode(self):
        self.assertEqual(
            [
                "02e649f63f8e8121345fd7f47d0d185a3ccaa84311" "5cd2e9392dcd9b82263bc680",
                "021c7359cd885c0e319924d97e3980206ad64387af" "f54908241125b3a88b55ca16",
                "02f561e0b57a552df3fa1df2d87a906b7a9fc33a83" "d5d15fa68a644ecb0806b49a",
                "03e7595c3e6b58f907bee951dc29796f3757307e70" "0ecf3d09307a0cc4a564eba3",
            ],
            [
    ...
    def test_Base58CheckDecode(self):
        self.assertEqual(
            [
                "02e649f63f8e8121345fd7f47d0d185a3ccaa84" "3115cd2e9392dcd9b82263bc680",
                "021c7359cd885c0e319924d97e3980206ad6438" "7aff54908241125b3a88b55ca16",
                "02f561e0b57a552df3fa1df2d87a906b7a9fc33" "a83d5d15fa68a644ecb0806b49a",
                "03e7595c3e6b58f907bee951dc29796f3757307" "e700ecf3d09307a0cc4a564eba3",
    ...
    def test_Base58(self):
        self.assertEqual(
            [
                format(Base58("02b52e04a0acfe611a4b6963462aca94b6ae02b24e321eda865076619" "01adb49"), "wif"),
                format(Base58("5b921f7051be5e13e177a0253229903c40493df410ae04f4a450c8556" "8f19131"), "wif"),
                format(Base58("0e1bfc9024d1f55a7855dc690e45b2e089d2d825a4671a3c3c7e4ea4e" "74ec00e"), "wif"),
                format(Base58("6e5cc4653d46e690c709ed9e0570a2c75a286ad7c1bc69a648aae6855" "d919d3e"), "wif"),
                format(Base58("b84abd64d66ee1dd614230ebbe9d9c6d66d78d93927c395196666762e" "9ad69d8"), "wif"),
            ],
            [
