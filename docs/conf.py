...
latex_documents = [
    (master_doc, "golos-python.tex", "golos-python Documentation", "furion@steemit.com", "manual"),
]
...
man_pages = [(master_doc, "golos-python", "golos-python Documentation", [author], 1)]
